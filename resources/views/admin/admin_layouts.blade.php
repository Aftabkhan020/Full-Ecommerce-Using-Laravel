...
<!--Tag input CDN-->
  ...
  <body>
    ...
    <!-- ########## START: LEFT PANEL ########## -->
    <div class="sl-logo"><a href=""><i class="icon ion-android-star-outline"></i> starlight</a>
    </div>
    <div class="sl-sideleft">
      ...
      <div class="sl-sideleft-menu">
        ...
        <ul class="sl-menu-sub nav flex-column">
          ...
          <li class="nav-item"><a href="{{ route('add.blogpost') }}" class="nav-link">Add Blog</a></li>
          <li class="nav-item"><a href="{{ route('all.blogpost') }}" class="nav-link">All Blog</a></li>
        </ul>
