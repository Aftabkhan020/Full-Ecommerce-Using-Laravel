...
<div class="sl-mainpanel">
      ...
      <div class="sl-pagebody">
        ...
        <div class="card pd-20 pd-sm-40">
          ...
          <p class="mg-b-20 mg-sm-b-30">Product Edit Form</p>
            ...
            <div class="col-lg-4">
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="product_color" data-role="tagsinput" value="{{ $product->product_color }}">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="col-lg-4">
                <div class="form-group">
                  ...
                  <input class="form-control" type="text" name="selling_price" id="size" value="{{ $product->selling_price }}">
                </div>
              </div><!-- col-4 -->
              ...
              <div class="row">
              <div class="col-lg-6 col-sm-6">
                  <label class="form-control-label">Second Image: <span class="tx-danger">*</span></label><br>
                  <label class="custom-file">
              ...
              <div class="col-lg-6 col-sm-6">
                  ...
                  <label class="form-control-label">Third Image: <span class="tx-danger">*</span></label><br>
                  <label class="custom-file">
